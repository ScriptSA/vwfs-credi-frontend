"use strict";
(self["webpackChunkvwfs_credi_frontend"] = self["webpackChunkvwfs_credi_frontend"] || []).push([["default-src_app_shared_auth_auth_service_ts-node_modules_angular_material_fesm2020_icon_mjs"],{
  ...
  login(username, password) {
    ...
    return (0,C_workspace_bbva_vwfs_credi_frontend_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      return new Promise((resolve, reject) => {
        _this.http.post(_this.baseBackendUrl + _this.loginUrl, {
          'legajo': username,
          'password': password
        }).subscribe({
          next: data => {
            if (!_this.isEmpty(data) && data != undefined && data.data != '') {
              _this.isAuthenticated = true;
              _this.currentUserId = data.data;
              resolve(true);
            } else {
...
//# sourceMappingURL=default-src_app_shared_auth_auth_service_ts-node_modules_angular_material_fesm2020_icon_mjs.js.map